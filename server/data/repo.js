...
const DEFAULT_SETTINGS = {
  ...
  // Прайс услуг для монтажников (server/data/services-repo.js) — отдельный
  // прайс-лист (услуги, а не материалы), своя настройка валюты на случай,
  // если понадобится другая, но по умолчанию тот же лари, что и выше.
  servicesCurrencySymbol: '₾',
  servicesSeeded: false, // true после первого автозаполнения базовыми услугами
  servicesNotice: 'БЫТОВАЯ ТЕХНИКА НЕ ПОДКЛЮЧАЕТСЯ К ЭЛЕКТРИЧЕСТВУ И ВОДЕ БЕЗ ПРЕДВАРИТЕЛЬНОЙ ПОДГОТОВКИ МЕСТ ПОДКЛЮЧЕНИЯ.\n'
    + '• Установка техники производится без подключения к коммуникациям.\n'
    + '• Подключение техники производится по согласованию с монтажником.\n'
    + '• Цены указаны без учёта акционных скидок.\n'
    + '• Сборочная компания имеет право увеличить стоимость сборки пропорционально скидке на товар.',
};
